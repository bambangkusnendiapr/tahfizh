        ...
        @csrf
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" required name="kategori" class="form-control @error('kategori') is-invalid @enderror" id="kategori" placeholder="Masukan Kategori">
            </div>
            <div class="form-group">
    ...
    <div class="modal-content">
      ...
      @csrf
        <div class="modal-body">
          <div class="form-group">
            <label for="kategori">Kategori</label>@error('kategori') <span class="text-danger">{{ $message }}</span> @enderror
            <input type="text" required value="{{ $data->kategori_nama }}" name="kategori" class="form-control @error('kategori') is-invalid @enderror" id="kategori">
          </div>
          <div class="form-group">
            <label for="ket">Keterangan</label>@error('ket') <span class="text-danger">{{ $message }}</span> @enderror
            <input type="text" value="{{ $data->kategori_ket }}" name="ket" class="form-control @error('ket') is-invalid @enderror" id="ket">
          </div>
        </div>
        <div class="modal-footer justify-content-between">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
