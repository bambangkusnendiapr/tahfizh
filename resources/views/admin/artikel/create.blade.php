              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" required name="judul" value="{{ old('judul') }}" class="form-control @error('judul') is-invalid @enderror" id="judul" placeholder="Judul..." autofocus>
                    @error('judul')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
              ...
              <div class="form-group">
                ...
                <div class="select2-primary">
                  <select class="select2" name="tag[]" multiple="multiple" data-placeholder="Pilih Tag" data-dropdown-css-class="select2-primary" style="width: 100%;">
                    @foreach($tag as $data)
                      <option value="{{ $data->id }}">#{{ $data->tag_nama }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
